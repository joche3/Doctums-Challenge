    ...
    <div className="bg-customSecondary-800">
      <PageContainer>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center min-h-[calc(100vh-80px)] px-6 md:px-20 py-10 ">
          ...
          <div className="text-left w-full md:w-3/4 mb-10 md:mb-0">
          ...
          <TexBoxBig3 className="w-[700px] h-[700px]">
              {/* Contenido de la tarjeta */}
              <div className="relative p-24 mt-10">
                {/* Texto del juego */}
                <p className="text-customSecondary-800 text-xl mb-6 leading-relaxed font-digitalThin text-justify">
