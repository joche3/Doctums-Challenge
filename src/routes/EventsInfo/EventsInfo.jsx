            ...
            <div className='flex flex-row justify-around items-center h-full'>
              ...
              <div className='flex flex-col w-2/6'>
                <div>
                  ...
                  <h1 className=' text-white font-pixelmixNormal text-4xl'>Eventos</h1>
                </div>

                <div className='mt-5 text-white text-xl mb-6 leading-relaxed font-digitalThin text-justify'>
                  <p>
                    Los eventos son situaciones que surgen en la empresa, representando oportunidades y riesgos. Se clasifican en cotidianos, complejos y críticos, donde un nivel más alto implica mayores beneficios y riesgos. Para enfrentarlos, lanzarás dados según su nivel y compararás el resultado con la fortaleza de tu eficiencia. Si el resultado es igual o menor, habrás tenido éxito; si es mayor, enfrentarás consecuencias negativas.
                  </p>
                </div>
              </div>
              ...
              <div className=''>
                <img src="./src/assets/img/eventsInfo.png" alt="" className='w-[500px]'/>
              </div>
