          ...
          >
            ...
            <div className="relative p-24">
              <p className="text-gray-800 text-lg mb-6 leading-relaxed font-digitalThin text-justify">
                Los eventos son situaciones que surgen en la empresa, representando oportunidades y riesgos. 
                Se clasifican en cotidianos, complejos y críticos, donde un nivel más alto implica mayores beneficios y riesgos.
                Para enfrentarlos, lanzarás dados según su nivel y compararás el resultado con la fortaleza de tu eficiencia. 
                Si el resultado es igual o menor, habrás tenido éxito; si es mayor, enfrentarás consecuencias negativas.
              </p>
            </div>
          </div>
        </div>
