            ...
            <div className='flex flex-row justify-around items-center h-full'>
              ...
              <div className='flex flex-col w-2/6'>
                <div>
                  ...
                  <h1 className=' text-white font-pixelmixNormal text-4xl'>Recursos</h1>
                </div>

                <div className='mt-5 text-white text-xl mb-6 leading-relaxed font-digitalThin text-justify'>
                  <p>
                    Para fortalecer el equipo de la PMO, se podrá contratar personal de diversas áreas de especialidad. Cada contratación afectará las eficiencias según el área y el nivel del recurso.
                    Solamente se podrá hacer una
                    contratación por turno, como máximo.
                  </p>
                </div>
              </div>
              ...
              <div className=''>
                <img src="./src/assets/img/recursoInfo.png" alt="" className='w-[700px]' />
              </div>
