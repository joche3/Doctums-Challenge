        ...
        <div className="flex flex-col items-center md:items-start justify-start min-h-[calc(100vh-80px)] px-6 md:px-20 py-10 relative transform -translate-x-[240px]">
          ...
          >
            ...
            <div className="relative p-24">
              ...
              Los proyectos son esfuerzos planificados que buscan generar resultados significativos en la gestión del proyecto, 
              con costos generalmente más altos que los productos. Se controlan mediante una lista que incluye número de referencia, 
              nombre, costo y duración. Los proyectos se pueden iniciar en el primer turno de cada mes, y se obtienen beneficios solo al concluirlos
              </p>
            </div>
          </div>
        </div>
